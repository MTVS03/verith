...
class TechnicalReport(Base):
    ...
    final_regime: Mapped[str | None] = mapped_column(String, nullable=True)
    daily_regime: Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    alignment_flag: Mapped[str | None] = mapped_column(String, nullable=True)
